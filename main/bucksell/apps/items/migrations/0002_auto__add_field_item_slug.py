...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('items_item', 'slug', self.gf('django.db.models.fields.CharField')(max_length=60))
    
    
    def backwards(self, orm):
        
        # Changing field 'Item.slug'
        db.delete_column('items_item', 'slug', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 3, 30, 30, 572685)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 3, 30, 30, 572578)'}),
