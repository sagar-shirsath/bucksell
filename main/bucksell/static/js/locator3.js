...
//    }
    $.each($('input[type=hidden]'), function () {
        ...
        var myHtml = '<div style="text-align: center; text-overflow: ellipsis;overflow-x: hidden" id=' + item_id + '><img src=' + img_src + ' height=70px width=70px/>' +
            '' + item_name + '<br>'+price+'</div>';
